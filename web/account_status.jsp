...
<header style="height: 120px;width: 100%;background-color: rgb(27,27,26);position: relative;">
    ...
    <div class="main-div" style="width: 100%;height: 100%;display: flex;flex-direction: column;align-items: center;">
        <h1 class="item-heading" style="text-align: center;padding-bottom: 16px;padding-top: 16px;font-size: x-large;">Account Status</h1>
        ...
        </div><button class="btn btn-primary tcs-button" type="button" style="padding: 8px 24px;font-weight: 500;">Refresh the list</button></div>
    <footer class="footer">

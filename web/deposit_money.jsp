...
<header style="height: 120px;width: 100%;background-color: rgb(27,27,26);position: relative;">
    ...
    <div class="main-div" style="width: 100%;height: 100%;">
        <h1 class="item-heading" style="text-align: center;padding-bottom: 16px;padding-top: 16px;font-size: x-large;">Withdraw Money</h1>
        <div class="container create-customer">
            ...
            <div class="row">
                <div class="col">
                    <p class="create-customer-fieldtext">Account ID:</p>
                </div>
                <div class="col" style="align-items: center;">
                    <p>%%##accid##%%<br></p>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <p class="create-customer-fieldtext">Account Type:</p>
                </div>
                <div class="col" style="align-items: center;">
                    <p>%%##acctype##%%<br></p>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <p class="create-customer-fieldtext">Balance:</p>
                </div>
                <div class="col" style="align-items: center;">
                    <p>%%##balance##%%<br></p>
                </div>
            ...
            <div class="row">
                <div class="col" style="max-width: 1000%;">
                    <p class="create-customer-fieldtext">Withdraw Amount:</p>
                </div>
                <div class="col" style="align-items: center;"><input type="number" class="updatecustomer-input"></div>
            </div>

    ...
    <div style="display: flex;width: 100%;height: calc(100vh - 40px);align-items: center;justify-content: center;">
        <div class="container create-customer">
            ...
            <div class="row" style="/*text-align: center;*/">
                <div class="col" style="text-align: center;margin-right: 0px;padding-top: 20px;"><button class="btn btn-primary tcs-button create-customer-btn" type="button" style="margin-right: 0px;color: rgb(239,239,239);border-radius: 4px;width: 40%;">View</button></div>
            </div>
        </div>
    </div>

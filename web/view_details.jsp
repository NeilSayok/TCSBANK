...
<%
    ...
    CustomerDet c = new CustomerDAO().getCustomerByCustID(Integer.parseInt(request.getParameter("custid")));
...
<div class="main-div" style="width: 100%;height: 100%;">
    <h1 class="item-heading" style="text-align: center;padding-bottom: 16px;padding-top: 16px;font-size: x-large;">View Customer Details</h1>
    <div class="container create-customer">
        ...
        <div class="row">
            ...
            <div class="col" style="align-items: center;">
                <p id="emp_name"><%=c.getSsn_id()%></p>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <p class="create-customer-fieldtext">Customer Name</p>
            </div>
            <div class="col" style="align-items: center;">
                <p ><%=c.getCust_name()%></p>
            </div>
        ...
        <div class="row">
            <div class="col">
                <p class="create-customer-fieldtext">Cusomer Age</p>
            </div>
            <div class="col" style="align-items: center;">
                <p ><%=c.getCust_age()%></p>
            </div>
        ...
        <div class="row">
            <div class="col">
                <p class="create-customer-fieldtext">Customer Address</p>
            </div>
            <div class="col" style="align-items: center;">
                <p ><%=c.getCust_address()%></p>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <p class="create-customer-fieldtext">Customer State</p>
            </div>
            <div class="col" style="align-items: center;">
                <p ><%=c.getCust_state()%></p>
            </div>
        ...
        <div class="row">
            <div class="col">
                <p class="create-customer-fieldtext">Customer City</p>
            </div>
            <div class="col" style="align-items: center;">
                <p ><%=c.getCust_city()%></p>
            </div>

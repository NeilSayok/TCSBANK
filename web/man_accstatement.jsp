...
<header style="height: 120px;width: 100%;background-color: rgb(27,27,26);position: relative;">
    ...
    <div class="main-div" style="width: 100%;height: 100%;">
        ...
        <div class="container create-customer" style="opacity: 1;">
            <div class="row">
                <div class="col">
                    <p class="create-customer-fieldtext">Account ID:<span style="color: red;"></span></p>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-1"><label class="form-check-label create-customer-fieldtext" for="formCheck-1">Last Number Of Transactions</label></div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-1"><label class="form-check-label create-customer-fieldtext" for="formCheck-1">Start-End Dates</label></div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <p class="create-customer-fieldtext" style="width: 100%;">Number of Transactions:</p>
                </div>
            ...
            <div class="row" style="text-align: center;">
                <div class="col" style="/*text-align: right;*//*margin-right: 0px;*/"><button class="btn btn-primary tcs-button create-customer-btn" type="button" style="/*margin-right: 0px;*/width: 40%;">Submit</button></div>
            </div>
        </div>
        <div class="statement-tablediv"></div>
    </div>
    <footer class="footer">

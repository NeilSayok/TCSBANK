...
<header style="height: 120px;width: 100%;background-color: rgb(27,27,26);position: relative;">
    ...
    <div class="main-div" style="width: 100%;height: 100%;">
        <h1 class="item-heading" style="text-align: center;padding-bottom: 16px;padding-top: 16px;font-size: x-large;">Transfer Money</h1>
        <div class="container create-customer" style="opacity: 1;">
            ...
            <div class="row">
                <div class="col" style="max-width: 195px;">
                    <p class="create-customer-fieldtext">Source Account Type:<span style="color: red;"></span></p>
                </div>
                <div class="col" style="align-items: center;min-width: 2px;"><select style="margin-left: 0px;"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select></div>
            </div>
            <div class="row">
                <div class="col" style="max-width: 195px;">
                    <p class="create-customer-fieldtext">Target Account Type:<span style="color: red;"></span></p>
                </div>
                <div class="col" style="align-items: center;min-width: 2px;"><select style="margin-left: 0px;"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select></div>
            </div>
            <div class="row">
                <div class="col">
                    <p class="create-customer-fieldtext">Transfer Amount:<span style="color: red;"></span></p>
                </div>
                <div class="col" style="align-items: center;"><input type="number" class="createcustomer-input"></div>
            </div>
            <div class="row" style="text-align: center;">
                <div class="col" style="/*text-align: right;*//*margin-right: 0px;*/"><button class="btn btn-primary tcs-button create-customer-btn" type="button" style="/*margin-right: 0px;*/width: 40%;">Transfer</button></div>
            </div>
        </div>
    </div>
    <footer class="footer">
